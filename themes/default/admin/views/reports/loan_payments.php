...
if ($this->input->post('loan_ref')) {
    $v .= '&loan_ref=' . $this->input->post('loan_ref');
}
...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getLoanPaymentsReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld}, null, {"mRender": ref}, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bVisible": false}],
            ...
            {column_number: 2, filter_default_label: "[<?=lang('loan_ref');?>]", filter_type: "text", data: []},
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('reports/loan_payments', 'autocomplete="off"'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang('loan_ref', 'loan_ref'); ?>
                                <?php echo form_input('loan_ref', ($_POST['loan_ref'] ?? ''), 'class="form-control tip" id="loan_ref"'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getLoanPaymentsReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getLoanPaymentsReport/0/xls/?v=1' . $v)?>";
            return false;
        });
