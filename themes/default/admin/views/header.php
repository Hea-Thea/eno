        ...
        <table class="lt"><tr><td class="sidebar-con">
            <div id="sidebar-left">
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    ...
                    <!-- <li class="mm_agencies">
                        <a class="dropmenu" href="#">
                            <i class="fa fa-users"></i>
                            <span class="text"> <?= lang('agencies'); ?>
                        </span> <span class="chevron closed"></span>
                    </a>
                    <ul>
                        
                        <li id="agencies_index">
                            <a class="submenu" href="<?= admin_url('agencies'); ?>">
                                <i class="fa fa-users"></i><span class="text"> <?= lang('list_agencies'); ?></span>
                            </a>
                        </li>
                        <li id="agencies_index">
                            <a class="submenu" href="<?= admin_url('agencies/add'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_agency'); ?></span>
                            </a>
                        </li>
                    </ul> -->

                    <!-- <li class="mm_guarantors">
                        <a class="dropmenu" href="#">
                            <i class="fa fa-users"></i>
                            <span class="text"> <?= lang('guarantors'); ?>
                        </span> <span class="chevron closed"></span>
                    </a>
                    <ul>
                        
                        <li id="guarantors_index">
                            <a class="submenu" href="<?= admin_url('guarantors'); ?>">
                                <i class="fa fa-users"></i><span class="text"> <?= lang('list_guarantors'); ?></span>
                            </a>
                        </li>
                        <li id="guarantors_index">
                            <a class="submenu" href="<?= admin_url('guarantors/add'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_guarantor'); ?></span>
                            </a>
                        </li>
                    </ul> -->
                    ...
                    <ul>
                        ...
                        <li id="loans_add">
                            <a class="submenu" href="<?= admin_url('loans/add'); ?>" >
                                <i class="fa fa-plus-circle"></i>
                                <span class="text"> <?= lang('add_loan'); ?></span>
                            </a>
                        </li>
                    </ul> -->
                    ...
                    <ul>
                        ...
                        <li id="payments">
                            ...
                            <i class="fa fa-list-ul" aria-hidden="true"></i>
                                <span class="text"> <?= lang('list_payments'); ?></span>
                            </a>
                        </li>
                        <!--
                       <li id="payments_add">
                            <a class="submenu" href="<?= admin_url('payments/add'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i>
                    ...
                    <li class="mm_payments">
                        <a class="dropmenu" href="#">
                            ...
                            <span class="text"> <?= lang('Dictionary'); ?>
                        </span> <span class="chevron closed"></span>
                    </a>
                    <ul>
                        
                        <li id="payments">
                            <a class="submenu" href="<?= admin_url('dictionary/index'); ?>">
                                <i class="fa fa-file-word-o"></i>
                                <span class="text"> <?= lang('Words'); ?></span>
                            </a>
                        </li>
                        <li id="payments">
                            <a class="submenu" href="<?= admin_url('general'); ?>">
                                <i class="fa fa-th"></i>
                                <span class="text"> <?= lang('General'); ?></span>
                            </a>
                        </li>
                        <!-- <li id="payments_add">
                            <a class="submenu" href="<?= admin_url('payments/add'); ?>" data-toggle="modal" data-target="#myModal">
                     ...
                     <!-- <ul>
                        ...
                        <li id="payments">
                            <a class="submenu" href="<?= admin_url('dictionary'); ?>">
                                <i class="fa fa-file-word-o"></i>
                                <span class="text"> <?= lang('Words'); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                            ...
                            <ul>
                                <li id="system_settings_index">
                                    ...
                                    <a href="<?= admin_url('languages/view') ?>">
                        
                                    <i class="fa fa-language" aria-hidden="true"></i><span class="text"> <?= lang('Language'); ?></span>
                                    </a>
                                </li>
                                <?php if (POS) {
                                    ?>
                                    <li id="pos_settings">
                                        <a href="<?= admin_url('typeofspeech/add') ?>">
                                            <i class="fa fa-th-large"></i><span class="text"> <?= lang('Part Of Speech'); ?></span>
                                        </a>
                                    </li>
                                    <li id="promos_index">
                                        <a href="<?= admin_url('word_category/index') ?>">
                                        <i class="fa fa-flickr" aria-hidden="true"></i> <span class="text"> <?= lang('Word Category'); ?></span>
                                        </a>
                                    </li>
                                    <li id="Type_Of_Payment">
                                        <a href="<?= admin_url('typeofpayment') ?>">
                                            <i class="fa fa-th-large"></i><span class="text"> <?= lang('Type_Of_Payment'); ?></span>
                                        </a>
                                    </li>
                                    <!-- <li id="pos_printers">
                                        <a href="<?= admin_url('typeofpayment/index') ?>">
                                        <i class="fa fa-credit-card" ></i><span class="text"> <?= lang('Type_Of_Payment'); ?></span>
                                        </a>
                                    </li> -->
                                ...
                                <!-- 
                                <li id="loan_types_index">
                                    <a href="<?= admin_url('system_settings/loan_types') ?>">
                                        <i class="fa fa-file-text"></i><span class="text"> <?= lang('loan_types'); ?></span>
                                    </a>
                                </li>
                                <li id="holidays_index">
                                    <a href="<?= admin_url('system_settings/holidays') ?>">
                                        <i class="fa fa-file-text"></i><span class="text"> <?= lang('holidays'); ?></span>
                                    </a>
                                </li>
