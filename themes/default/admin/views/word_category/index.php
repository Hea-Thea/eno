...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('word_category/getAllWord') ?>',
...
<?php if ($Owner || ($GP && $GP['bulk_actions'])) {
    echo admin_form_open('word_category/delete_action', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('word_category/action_addWord'); ?>" data-toggle="modal" data-target="#myModal" id="adds">
                                <i class="fa fa-plus-circle"></i> <?= lang('Add_Word_Category'); ?>
                            </a>
                        </li>
                        <!-- <li>
...
<?php if ($Owner || ($GP && $GP['bulk_actions'])) {
    ...
    <div style="display: none;">
        <input type="hidden" name="word_action" value="" id="form_action"/>
