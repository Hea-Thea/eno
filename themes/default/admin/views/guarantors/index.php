...
<script>
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('guarantors/getGuarantors') ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[0];
                nRow.className = "guarantor_details_link";
                return nRow;
            },
            "aoColumns": [{
                "bSortable": false,
...
<?php if ($Owner || ($GP && $GP['bulk_actions'])) {
    echo admin_form_open('guarantors/guarantor_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('guarantors'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('guarantors/add'); ?>" data-toggle="modal" data-target="#myModal" id="add">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_guarantor'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('guarantors/import_csv'); ?>" data-toggle="modal" data-target="#myModal">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line('delete_guarantors') ?></b>"
                                ...
                                <i class="fa fa-trash-o"></i> <?= lang('delete_guarantors') ?>
                            </a>
                        </li>
                    </ul>
                </li>
