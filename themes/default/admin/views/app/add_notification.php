...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('app_settings/add_notification', $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?= form_input('link', set_value('link'), 'class="form-control' . ($Settings->use_code_for_slug ? ' gen_slug' : '') . '" id="link" '); ?>
            </div>
