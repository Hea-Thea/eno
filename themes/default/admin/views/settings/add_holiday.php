...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('system_settings/add_holiday', $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?= form_input('from_date', (isset($_POST['from_date']) ? $_POST['from_date'] : ''), 'class="form-control date" id="from_date" required="required"'); ?>
            </div>

            <div class="form-group">
                <?= lang('to_date', 'to_date'); ?>
                <?= form_input('to_date', (isset($_POST['to_date']) ? $_POST['to_date'] : ''), 'class="form-control date" id="to_date" required="required"'); ?>
            </div>
