    ...
    <div class="box-content">
        <div class="row">
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        <tbody>
										...
										//https://www.daniweb.com/web-development/php/threads/105292/increment-date-by-week
											$number_payment=$inv->term;
											$loan_term=$inv->loan_term_id;
											$amount=$inv->amount;
											$interest=$inv->interest_rate;
											$using_interest_id=$inv->interest_type_id;
											$week_term=0;
											if($loan_term==1){
												//TERMS (Daily)
											...
											if($week_term==1 || $week_term==2 || $week_term==3){
													...
													$startdate = strtotime($inv->first_payment_date);
			...
			<tr>
													...
													<td> <?php echo number_format(round($inv->amount-$amount_princeple,2),2); ?><?php echo "";//$cur_type;?></td>
													<!--<td> <?php //echo number_format(round($loans -> row() -> amount/$number_payment,2),2); ?>$</td>-->
													
													<td> <?php echo number_format(round($payment,2),2); ?><?php echo "$";//$cur_type;?></td>
													<td>&nbsp;</td>
												</tr>
													<?php
														$increment++;
														...
														$i++;
														$amount_princeple+=$inv->amount/$number_payment;
													}
												}else if ($loan_term==1){
