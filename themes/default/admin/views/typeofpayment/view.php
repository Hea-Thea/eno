...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('typeofpayment/gettypeofpayment') ?>',
...
<?php if ($Owner || ($GP && $GP['bulk_actions'])) {
    echo admin_form_open('typeofpayment/typeofpayment_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Type of Payment'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('typeofpayment/action_user'); ?>" data-toggle="modal" data-target="#myModal" id="add">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_new_type_of_payment'); ?>
                            </a>
                        </li>
                        <?php if ($Owner) {
                            ?>
                        ...
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line('delete_type_of_payment') ?></b>"
                                ...
                                <i class="fa fa-trash-o"></i> <?= lang('delete_type_of_payment') ?>
                            </a>
                        </li>
                        <?php }?>
                    </ul>
